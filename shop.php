                                                ...
                                                <div class="card-body p-4">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-3 col-lg-12">
                                                            <a href="add-product.php" class="btn btn-primary btn-block float-end my-2"><i class="fa fa-plus-square me-2"></i>New Product</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                <ul class="icons">
                                                                    <li>
                                                                        <a href="shop-description.php" class="btn btn-primary"> <i class="fe fe-eye">  </i> </a>
                                                                    </li>
                                                                    <li><a href="add-product.php" class="btn btn-success"><i  class="fe fe-edit"></i></a></li>
                                                            ...
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Candy Pure Rose Water</a></h1>
                                                            ...
                                                            <div class="card-footer text-center">
                                                                <a href="cart.php" class="btn btn-primary mb-1"><i class="fe fe-shopping-cart mx-2"></i>Add to cart</a>
                                                                <a href="wishlist.php" class="btn btn-outline-primary mb-1"><i class="fe fe-heart mx-2 wishlist-icon"></i>Add to wishlist</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/10.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">White Tshirt for Men</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/4.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Flower Pot for Home Decor</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/8.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Stylish Rockerz 255 Ear Pods</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/1.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Women Party Wear Dress</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/6.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Black Digital Camera</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/5.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Men shirt for party wear</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/7.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Light pink nail polish</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                    ...
                                                    <div class="card">
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                ...
                                                                <a href="shop-description.php" >
                                                                    <img class="img-fluid br-7 w-100" src="assets/images/pngs/3.jpg" alt="img">
                                                                </a>
                                                            </div>
                                                            <div class="card-body pt-0">
                                                                <div class="product-content text-center">
                                                                    <h1 class="title fw-bold fs-20"><a href="shop-description.php">Running Shoes for men</a></h1>
                                                                    <div class="mb-2 text-warning">
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                                        <i class="fa fa-star text-warning"></i>
                                                            ...
                                                            <div class="row g-0">
                                                                <div class="col-xl-3 col-lg-12 col-md-12">
                                                                    <div class="product-list">
                                                                        <div class="product-image">
                                                                            <ul class="icons">
                                                                                <li><a href="shop-description.php" class="btn btn-primary"><i class="fe fe-eye text-white "></i></a></li>
                                                                                <li><a href="add-product.php" class="btn btn-success"><i class="fe fe-edit text-white "></i></a></li>
                                                                                <li><a href="wishlist.php" class="btn btn-danger"><i class="fe fe-x text-white"></i></a></li>
                                                                            </ul>
                                                                        </div>
                                                                        <div class="br-be-0 br-te-0">
                                                                            <a href="shop-description.php" class="">
                                                                ...
                                                                <div class="col-xl-6 col-lg-12 col-md-12 border-end my-auto">
                                                                    <div class="card-body">
                                                                        <div class="mb-3">
                                                                            <a href="shop-description.php" class="">
                                                                                <h3 class="fw-bold fs-25 mb-3">Candy Pure Rose Water</h3>
                                                                                <div class="mb-2 text-warning">
                                                                ...
                                                                <div class="col-xl-3 col-lg-12 col-md-12 my-auto">
                                                                    <div class="card-body p-0">
                                                                        ...
                                                                        <a href="cart.php" class="btn btn-primary btn-block"><i class="fe fe-shopping-cart mx-2"></i>Add to cart</a>
                                                                        <a href="wishlist.php" class="btn btn-outline-primary btn-block mt-2"><i class="fe fe-heart mx-2 wishlist-icon"></i>Add to wishlist</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-xl-6 col-lg-12 col-md-12 border-end my-auto">
                                                                    <div class="card-body">
                                                                        <div class="mb-3">
                                                                            <a href="shop-description.php" class="">
                                                                                <h3 class="fw-bold fs-25 mb-3">White Tshirt for Men</h3>
                                                                                <div class="mb-2 text-warning">
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                            ...
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-xl-6 col-lg-12 col-md-12 border-end my-auto">
                                                                    <div class="card-body">
                                                                        <div class="mb-3">
                                                                            <a href="shop-description.php" class="">
                                                                                <h3 class="fw-bold fs-25 mb-3">Stylish Rockerz 255 Ear Pods</h3>
                                                                                <div class="mb-2 text-warning">
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                ...
                                                                <div class="col-xl-3 col-lg-12 col-md-12 my-auto">
                                                                    <div class="card-body p-0">
                                                                        ...
                                                                        <a href="cart.php"><span  class="btn btn-primary btn-block"><i class="fe fe-shopping-cart mx-2"></i>Add to cart</span></a>
                                                                        <a href="wishlist.php"><span  class="btn btn-outline-primary btn-block mt-2"><i class="fe fe-heart mx-2 wishlist-icon"></i>Add to wishlist</span></a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-xl-6 col-lg-12 col-md-12 border-end my-auto">
                                                                    <div class="card-body">
                                                                        <div class="mb-3">
                                                                            <a href="shop-description.php" class="">
                                                                                <h3 class="fw-bold fs-25 mb-3">Flower Pot for Home Decor</h3>
                                                                                <div class="mb-2 text-warning">
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                            ...
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-xl-6 col-lg-12 col-md-12 border-end my-auto">
                                                                    <div class="card-body">
                                                                        <div class="mb-3">
                                                                            <a href="shop-description.php" class="">
                                                                                <h3 class="fw-bold fs-25 mb-3">Running Shoes for men</h3>
                                                                                <div class="mb-2 text-warning">
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
                                                                                    <i class="fa fa-star fs-18 text-warning"></i>
