                                        ...
                                        <div class="card-body">
                                            <ul class="nav nav-pills">
                                                ...
                                                <li class="nav-item dropdown m-2">
                                                    <a class="nav-link dropdown-toggle px-4 py-2" data-bs-toggle="dropdown" href="javascript:void(0)" role="button" aria-haspopup="true" aria-expanded="false">Dropdown Menu</a>
