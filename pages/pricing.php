                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="row">
                                ...
                                <h4 class="card-title mt-4">Pricing cards 4 colums</h4>
                                <!-- ROW-4 OPEN -->
                                <div class="col-sm-6 col-xxl-3 col-xl-6 col-md-6 col-lg-6 primary">
                                    <div class="card">
                                ...
                                <!-- COL-END -->
                                <div class="col-sm-6 col-xxl-3 col-xl-6 col-md-6 col-lg-6 danger">
                                    <div class="card">
                                        <div class="princing-item">
                                            <div class="pricing-divider text-center pt-5">
                                ...
                                <div class="col-sm-6 col-xxl-3 col-xl-6 col-md-6 col-lg-6 success">
                                    <div class="card">
                                        <div class="princing-item">
                                            <div class="pricing-divider text-center pt-5">
                                ...
                                <!-- COL-END -->
                                <div class="col-sm-6 col-xxl-3 col-xl-6 col-md-6 col-lg-6 secondary">
                                        ...
                                        <div class="tab-pane pb-0 active show" id="annualyear">
                                            <div class="row d-flex align-items-center justify-content-center">
                                                    ...
                                                    <div class="card p-3 border-primary pricing-card advanced">
                                                        ...
                                                        <div class="card-body pt-2">
                                                            <ul class="text-justify pricing-body ps-0">
                                                                ...
                                                                <li class="mb-5"><i class="mdi mdi-checkbox-marked-circle-outline text-primary p-2 fs-16"></i><strong> 24/7</strong> support</li>
                                                            </ul>
                                                        </div>
                                                        <div class="card-footer text-center border-top-0 pt-1">
                                                ...
                                                <div class="col-sm-6 col-xxl-3 col-xl-6 col-md-6 col-lg-6">
                                                    <div class="card p-3 pricing-card">
                                                        <div class="card-header d-block text-justified pt-2">
                                                            ...
                                                            <p class="text-justify fw-semibold mb-1"> <span class="fs-30 me-2">$</span><span class="fs-30 me-1">699</span><span class="fs-25"><span class="op-0-5 text-muted text-20">/</span> year</span></p>
                                                            <p class="fs-13 mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</p>
                                                ...
                                                <div class="col-sm-6 col-xxl-3 col-xl-6 col-md-6 col-lg-6">
                                                    <div class="card p-3 pricing-card">
                                                        <div class="card-header d-block text-justified pt-2">
                                                            <p class="fs-18 fw-semibold mb-1">Premium</p>
                                                            <p class="text-justify fw-semibold mb-1"> <span class="fs-30 me-2">$</span><span class="fs-30 me-1">999</span><span class="fs-25"><span class="op-0-5 text-muted text-20">/</span> year</span></p>
                                                            <p class="fs-13 mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</p>
                                                            <p class="fs-13 mb-1  text-success">Billed monthly on regular basis!</p>
                                                        </div>
                                                        <div class="card-body pt-2">
                                                            <ul class="text-justify pricing-body ps-0">
                                                                <li><i class="mdi mdi-checkbox-marked-circle-outline text-success p-2 fs-16"></i><strong> 1 Free</strong> Domain Name</li>
                                                                <li><i class="mdi mdi-checkbox-marked-circle-outline text-success p-2 fs-16"></i><strong>5 </strong> One-Click Apps</li>
                                                                <li><i class="mdi mdi-checkbox-marked-circle-outline text-success p-2 fs-16"></i><strong> 3 </strong> Databases</li>
                                                                <li class="text-muted"><i class="mdi mdi-close-circle-outline text-success p-2 fs-16"></i><strong> Unlimited </strong> Cloud Storage</li>
                                                                <li class="text-muted"><i class="mdi mdi-close-circle-outline text-gray p-2 fs-16"></i><strong> Money </strong> BackGuarantee</li>
                                                                <li class="text-muted"><i class="mdi mdi-close-circle-outline text-gray p-2 fs-16"></i><strong> 24/7</strong> support</li>
                                                            </ul>
                                                        </div>
                                            ...
                                            <div class="row d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="col-sm-6 col-xxl-3 col-xl-6 col-md-6 col-lg-6">
                                                    <div class="card p-3 pricing-card">
                                                        <div class="card-header d-block text-justified pt-2">
                                                            <p class="fs-18 fw-semibold mb-1">Premium</p>
                                                            <p class="text-justify fw-semibold mb-1"> <span class="fs-30 me-2">$</span><span class="fs-30 me-1">99</span><span class="fs-25"><span class="op-0-5 text-muted text-20">/</span> month</span></p>
                                                            <p class="fs-13 mb-1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure quos debitis aliquam .</p>
                                                            <p class="fs-13 mb-1  text-success">Billed monthly on regular basis!</p>
                                                        </div>
                                                        <div class="card-body pt-2">
