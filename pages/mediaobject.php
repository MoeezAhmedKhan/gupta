                                        ...
                                        <div class="card-body">
                                            <div class="example">
                                                <div class="media media-lg mt-0">
                                                    <img class="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src="../assets/images/media/media3.jpg" alt="Generic placeholder image">
                                ...
                                <div class="col-12">
                                    <div class="card Relatedpost nested-media overflow-hidden">
                                        ...
                                        <div class="card-body overflow-hidden">
                                            <div class="example">
                                                <div class="media media-lg mt-0">
                                                    <img class="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src="../assets/images/media/media5.jpg" alt="Generic placeholder image">
                                                    <div class="media-body overflow-hidden">
                                                        <h4 class="mt-0">Media Heading</h4>
                                                        <p class="text-muted mb-0 fs-14">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                                        <div class="media media-lg mt-3">
                                                            <img class="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src="../assets/images/media/media2.jpg" alt="Generic placeholder image">
                                                            <div class="media-body overflow-hidden">
                                                                <h4 class="mt-0">Media Heading</h4>
                                                                <p class="text-muted mb-0 fs-14">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                                            </div>
                                            ...
                                            <div class="example">
                                                <ul class="list-unstyled">
                                                    <li class="media media-lg mt-0 border-bottom-0">
                                                        <img class="avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src="../assets/images/media/media4.jpg" alt="Generic placeholder image">
                                                        <div class="media-body">
                                ...
                                <div class="col-12">
                                    <div class="card Relatedpost nested-media">
                                        ...
                                        <div class="card-body">
                                            <div class="example">
                                                <div class="media media-lg mt-0">
                                                    <img class="align-self-start avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src="../assets/images/media/media3.jpg" alt="Generic placeholder image">
                                                    <div class="media-body">
                                                        <h4 class="mt-0">Top-Aligned Media</h4>
                                                        <p class="text-muted fs-14 mb-0">There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable.</p>
                                                ...
                                                <div class="media media-lg">
                                                    <img class="align-self-center avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src="../assets/images/media/media5.jpg" alt="Generic placeholder image">
                                                    <div class="media-body">
                                                ...
                                                <div class="media media-lg">
                                                    <img class="align-self-end avatar avatar-xl bradius me-3 mb-4 w-100p h-10" src="../assets/images/media/media4.jpg" alt="Generic placeholder image">
                                                    <div class="media-body">
                                        ...
                                        <div class="card-body">
                                            <div class="example">
                                                <div class="media media-lg mt-0">
                                                    ...
                                                    <img class="ms-2 mt-3 mb-3 bradius w-100p h-10" src="../assets/images/media/media2.jpg" alt="Generic placeholder image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
