                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="list-group list-group-transparent mb-0 file-manager file-manager-border">
                                                <h4>General</h4>
                                                <div>
                                                    <a href="checkout.php" class="list-group-item  d-flex align-items-center px-0 border-top br-0">
                                                        <i class="fe fe-user fs-18 me-2 text-success p-2"></i>Account
                                                    </a>
                                                </div>
                                                <div>
                                                    <a href="notify-list.php" class="list-group-item  d-flex align-items-center px-0 br-0">
                                                        <i class="fe fe-bell fs-18 me-2 text-secondary p-2"></i>Notifications
                                                    </a>
                                                </div>
                                                <div>
                                                    <a href="terms.php" class="list-group-item  d-flex align-items-center px-0 br-0">
                                                        <i class="fe fe-eye fs-18 me-2 text-primary p-2"></i> Appearances
                                                    </a>
                                                </div>
                                                <div>
                                                    <a href="editprofile.php" class="list-group-item  d-flex align-items-center px-0 br-0">
                                                        <i class="fe fe-lock fs-18 me-2 text-warning p-2"></i> Privacy & Security
                                                    </a>
                                                </div>
                                                <div>
                                                    <a href="services.php" class="list-group-item  d-flex align-items-center px-0 br-0">
                                                        <i class="fe fe-headphones fs-18 me-2 text-info p-2"></i> Help & Support
                                                    </a>
                                                </div>
                                                <div>
                                                    <a href="invoice.php" class="list-group-item  d-flex align-items-center px-0 br-0">
                                                ...
                                                <div>
                                                    <a href="about.php" class="list-group-item  d-flex align-items-center px-0 br-0">
