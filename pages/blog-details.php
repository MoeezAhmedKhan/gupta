                            ...
                            <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-md-flex">
                                                ...
                                                <a href="profile.php" class="d-flex mb-2"><i class="fe fe-user fs-16 me-1 p-3 bg-primary-transparent text-primary bradius"></i>
                                                    ...
                                                    <div class="media mb-5 overflow-visible d-block d-sm-flex">
                                                        ...
                                                        <div class="media-body overflow-visible">
                                                            ...
                                                            <div class="media overflow-visible">
                                                                <div class="me-3">
                                                                    <a href="profile.php"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/9.jpg"> </a>
                                                                </div>
                                                                <div class="media-body border p-4 overflow-visible br-5">
                                                                    <nav class="nav float-end">
                                                                        <div class="dropdown">
                                ...
                                <div class="col-xxl-4 col-xl-12">
                                            ...
                                            <div class="">
                                                <div class="d-flex overflow-visible">
                                                    ...
                                                    <div class="media-body valign-middle">
                                                        <a href="profile.php" class="fw-semibold text-dark">Simon Sais</a>
                                                ...
                                                <div class="d-flex overflow-visible mt-5">
                                                    ...
                                                    <div class="media-body valign-middle">
                                                        <a href="profile.php" class="fw-semibold text-dark">Cherry Blossom</a>
                                                        <p class="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                                                    </div>
                                                </div>
                                                <div class="d-flex overflow-visible mt-5">
                                                    ...
                                                    <div class="media-body valign-middle">
                                                        <a href="profile.php" class="fw-semibold text-dark">Ivan Notheridiya</a>
                                                        <p class="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                                                    </div>
                                                </div>
                                                <div class="d-flex overflow-visible mt-5">
                                                    ...
                                                    <div class="media-body valign-middle">
                                                        <a href="profile.php" class="fw-semibold text-dark">Manny Jah</a>
                                                        <p class="text-muted mb-0">There are many variations of passages of Lorem Ipsum available ...</p>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="">
                                                <div class="overflow-visible blog-media">
                                                  <img class="blog-img me-3" src="../assets/images/media/23.jpg">
                                                ...
                                                <div class="overflow-visible blog-media mt-5">
                                                  <img class="blog-img me-3" src="../assets/images/media/22.jpg">
                                                    <div class="flex-column  blog-content">
                                                ...
                                                <div class="overflow-visible blog-media mt-5">
                                                  <img class="blog-img me-3" src="../assets/images/media/12.jpg">
                                                    <div class="flex-column  blog-content">
                                                        <h4><a href="blog-details.php">Generator on the Internet..</a></h4>
                                                        <div class="text-muted">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                                                    </div>
                                                ...
                                                <div class="overflow-visible blog-media mt-5">
                                                  <img class="blog-img me-3" src="../assets/images/media/25.jpg">
                                                    <div class="flex-column  blog-content">
                                                        <h4><a href="blog-details.php">Voluptatem quia voluptas...</a></h4>
                                                        <div class="text-muted">Excepteur sint occaecat cupidatat non proident, accusantium sunt in culpa qui officia deserunt mollit anim id est laborum....</div>
                                                    </div>
