                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="row">
                                ...
                                <!-- COL END -->
                                <div class="col-md-6 col-xl-4">
                                    <div class="card text-success bg-success-transparent card-transparent">
                                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-xl-4">
                                    <div class="card overflow-hidden">
                                        ...
                                        <img src="../assets/images/media/9.jpg" class="card-img-bottom" alt="img">
                                    </div>
                                </div>
                                <div class="col-xl-4 col-md-12">
                                    <div class="card">
                                        <img src="../assets/images/media/media1.jpg" class="card-img-top" alt="img">
                            ...
                            <div class="row">
                                <div class="col-md-12  col-xl-6">
                                    <div class="card">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img src="../assets/images/media/22.jpg" class="card-img-left h-100" alt="img">
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title">Card title</h5>
                                ...
                                <div class="col-md-12  col-xl-6">
                                    <div class="card">
                                        <div class="row g-0">
                                            ...
                                            <div class="col-md-4">
                                                <img src="../assets/images/media/22.jpg" class="card-img-right h-100" alt="img">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-xl-12 col-md-12">
                                    <div class="mb-5 card-group overflow-hidden">
                                        <div class="card border-end shadow-none">
                                            <img src="../assets/images/media/22.jpg" class="card-img-top" alt="img">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                                <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                                        ...
                                        <div class="card border-end shadow-none">
                                            <img src="../assets/images/media/18.jpg" class="card-img-top" alt="img">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                        ...
                                        <div class="card shadow-none">
                                            <img src="../assets/images/media/6.jpg" class="card-img-top" alt="img">
                                            <div class="card-body">
                                                <h5 class="card-title">Card title</h5>
                                                ...
                                                <div class="tab-menu-heading tab-menu-heading-boxed">
                                                    <div class="tabs-menu-boxed">
                                                        ...
                                                        <ul class="nav panel-tabs fs-14">
                                                            ...
                                                            <li><a class="disabled" href="#disabletabs" data-bs-toggle="tab">Disabled</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
