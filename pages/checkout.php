                                        ...
                                        <div class="card-body">
                                            <div class="">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-3">
                                                        <h4 class="mb-1 fw-semibold fs-14"><a href="shop-description.php">Flower Pot for Home Decor</a></h4>
                                            ...
                                            <div class="mt-5">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-3">
                                                        <h4 class="mb-1 fw-semibold fs-14"><a href="shop-description.php">Black Digital Camera</a></h4>
                                                        <div class="text-warning fs-14">
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                            ...
                                            <div class="mt-5">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ms-3">
                                                        <h4 class="mb-1 fw-semibold fs-14"><a href="shop-description.php">Men shirt for party wear</a></h4>
                                                        <div class="text-warning fs-14">
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
                                                            <i class="fa fa-star"></i>
