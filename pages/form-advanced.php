                                    ...
                                    <form method="post" class="card">
                                        ...
                                        <div class=" card-body">
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-4 col-sm-12 mb-4 mb-lg-0">
                                                <input type="file" class="dropify" data-default-file="../assets/images/media/1.jpg" data-height="200"  />
                                                </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form>
                                                ...
                                                <button class="btn btn-primary py-1 px-4 mb-1" type="button">Submit</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
