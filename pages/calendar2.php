                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12 col-xl-5 col-xxl-3">
                                                            ...
                                                            <div class="card-footer">
                                                                <div class="media media-xs overflow-visible">
                                                                    ...
                                                                    <div class="media-body valign-middle">
                                                                        <a href="profile.php" class=" fw-semibold text-dark">John Paige</a><br>
                                                                        <a href="profile.php" class="text-muted mb-0"> View client profile</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="card border p-0 pt-3">
                                                            ...
                                                            <div class="card-footer">
                                                                <div class="media media-xs overflow-visible">
                                                                    ...
                                                                    <div class="media-body valign-middle">
                                                                        <a href="profile.php" class=" fw-semibold text-dark">Mozelle Belt</a><br>
                                                                        <a href="profile.php" class="text-muted mb-0"> View client profile</a>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col-md-12 col-xl-7 col-xxl-9">
