                                ...
                                <div class="col-xl-3">
                                    <div class="card">
                                        <div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
                                            ...
                                            <a href="email-inbox.php" class="list-group-item d-flex align-items-center active mx-4">
                                            ...
                                            <a href="email-inbox.php" class="list-group-item d-flex align-items-center mx-4">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="eamil-body mt-5">
                                                ...
                                                <div class="email-attch">
                                                    <p class="font-weight-semibold">3 Attachments <a href="filemanager-details.php">View</a></p>
                                                </div>
                                                <div class="row attachments-doc">
                                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mb-2 mb-sm-0">
                                                        <div class="border overflow-hidden p-0 br-7">
                                                            <a href="filemanager-details.php"><img src="../assets/images/media/8.jpg" class="card-img-top" alt="img"></a>
                                                            <div class="p-3 text-center">
                                                                <a href="filemanager-details.php" class="fw-semibold fs-15 text-dark">Image.jpg</a>
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mb-2 mb-sm-0">
                                                        <div class="border overflow-hidden p-0 br-7">
                                                            <a href="filemanager-details.php"><img src="../assets/images/media/22.jpg" class="card-img-top" alt="img"></a>
                                                            <div class="p-3 text-center">
                                                                <a href="filemanager-details.php" class="fw-semibold fs-15 text-dark">Image2.jpg</a>
                                                    ...
                                                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 mb-2 mb-sm-0">
                                                        <div class="border overflow-hidden p-0 br-7">
                                                            <a href="filemanager-details.php"><img src="../assets/images/media/6.jpg" class="card-img-top" alt="img"></a>
                                                            <div class="p-3 text-center">
                                                                <a href="filemanager-details.php" class="fw-semibold fs-15 text-dark">Image3.jpg</a>
