                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="text-wrap">
                                                ...
                                                <div class="example">
                                                    <div class="btn-group mt-2 mb-2">
                                                        <button class="btn btn-primary btn-lg dropdown-toggle" type="button" data-bs-toggle="dropdown">Large Dropdown
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        <button class="btn btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown">Default Dropdown
                                                                <span class="caret"></span>
                                                            </button>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="javascript:void(0)">Action</a></li>
                                                    ...
                                                    <div class="btn-group mt-2 mb-2">
                                                        <button class="btn btn-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown">Small Dropdown
                                                                <span class="caret"></span>
                                                            </button>
                                                        <ul class="dropdown-menu">
                                                            <li><a href="javascript:void(0)">Action</a></li>
