                                                                ...
                                                                <div id="thumbcarousel" class="carousel slide" data-bs-interval="t">
                                                                    <div class="carousel-inner">
                                                                        <ul class="carousel-item active">
                                                                            ...
                                                                            <li data-bs-target="#Slider" data-bs-slide-to="1" class="thumb m-2"><img src="../assets/images/pngs/14.png" alt="img"></li>
                                                                            <li data-bs-target="#Slider" data-bs-slide-to="2" class="thumb m-2"><img src="../assets/images/pngs/12.png" alt="img"></li>
                                                                            <li data-bs-target="#Slider" data-bs-slide-to="3" class="thumb m-2"><img src="../assets/images/pngs/11.png" alt="img"></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="details col-xl-7 col-lg-12 col-md-12 mt-4 mt-xl-0">
                                                    <div class="mt-2 mb-4">
                                                        ...
                                                        <div class="btn-list mt-4">
                                                            <a href="cart.php" class="btn ripple btn-primary me-2"><i class="fe fe-shopping-cart"> </i> Add to cart</a>
                                                            <a href="checkout.php" class="btn ripple btn-secondary"><i class="fe fe-credit-card"> </i> Buy Now</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="media mb-5">
                                                <div class=" me-3">
                                                    <a href="javascript:void(0)"> <img class="media-object rounded-circle thumb-sm" alt="64x64" src="../assets/images/users/15.jpg"> </a>
                                                </div>
                                                <div class="media-body">
                                    ...
                                    <div class="card">
                                        <div class="product-grid6">
                                            <div class="product-image6 p-5">
                                                ...
                                                <a href="shop-description.php" class="bg-light">
                                            ...
                                            <div class="card-footer text-center">
                                                <a href="cart.php"><button type="button" class="btn btn-primary mb-1"><i class="fe fe-shopping-cart mx-2"></i>Add to cart</button></a>
                                                <a href="wishlist.php"><button type="button" class="btn btn-outline-primary mb-1"><i class="fe fe-heart mx-2"></i>Add to wishlist</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
