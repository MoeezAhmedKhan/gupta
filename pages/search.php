                                            ...
                                            <div class="tab-pane active" id="tab5">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="https://www.spruko.com/demo/templist/LTR/Templist/Html/index.html" target="_blank" class="text-primary">https://www.spruko.com/demo/templist/LTR/Templist/Html/index.html</a>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <a href="https://www.spruko.com/demo/zendash/zendash/HTML-LTR/Vertical-Icon-Light-Sidebar/index.html" target="_blank" class="text-primary">https://www.spruko.com/demo/zendash/zendash/HTML-LTR/Vertical-Icon-Light-Sidebar/index.html</a>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-2">
                                                            <a href="javascript:void(0)" class="h4 text-dark">Valex Website Templates from ThemeForest</a>
                                                        </div>
                                                        <a href="https://www.spruko.com/demo/valex/Valex/html/index.html" target="_blank" class="text-primary">https://www.spruko.com/demo/valex/Valex/html/index.html</a>
                                                        <p class="text-muted mt-2 mb-2">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia
                                                            dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                                                        <div>
                                                            <a href="javascript:void(0)"><i class="fa fa-star text-yellow fs-16"></i></a>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-2">
                                                            <a href="javascript:void(0)" class="h4 text-dark">DayOne – Web Hosting HTML Creative Responsive Clean Template</a>
                                                        </div>
                                                        <a href="https://spruko.com/demo/dayone/HTML/HTML/index.html" target="_blank" class="text-primary">https://spruko.com/demo/dayone/HTML/HTML/index.html</a>
                                                        <p class="text-muted mt-2 mb-1"> DayOne - Web Hosting HTML Creative Responsive Clean Template by sprukosoft DayOne -HTML Templates is a Clean, Simple Responsive Template Design.</p>
