                    ...
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                <h1 class="page-title">Extension-Tables</h1>
                                <div>
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="javascript:void(0)">Tables</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Extension-Tables</li>
                                    </ol>
                                </div>
                            </div>
                            <!-- PAGE-HEADER END -->
                                ...
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">DataTables Date Range Filter</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered text-nowrap w-30 datetimetable" border="0" cellspacing="5" cellpadding="5">
                                                    <tbody><tr>
                                                        <td>Minimum date:</td>
                                                ...
                                                <table id="datetime-table" class="table table-bordered text-nowrap mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>Position</th>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Basic Auto Fill Table</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="autofill-table" class="table table-bordered text-nowrap mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>Position</th>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Disable Horizontal Auto Fill</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="hor-autofill"  class="table table-bordered text-nowrap mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>Position</th>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h3 class="card-title">Enable Disable Autofill</h3>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table id="enable-autofill" class="table table-bordered text-nowrap mb-0">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>Position</th>
