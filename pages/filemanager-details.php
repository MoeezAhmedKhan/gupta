                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body pt-0 h-100">
                                            <div class="owl-carousel owl-carousel-icons2">
                                                ...
                                                <div class="item">
                                                    <div class="card overflow-hidden border p-0 mb-0 bg-white">
                                                        <a href="filemanager-details.php"><img src="../assets/images/media/files/01.jpg" alt="img" height="124" class="w-100"></a>
                                                        <div class="card-footer">
                                                            <div class="d-flex">
                                                                <div class="">
                                                                    <h5 class="mb-0 fw-semibold text-break">image.jpg</h5>
                                                                </div>
                                                                <div class="ms-auto my-auto">
                                                ...
                                                <div class="item">
                                                    <div class="card overflow-hidden border p-0 mb-0 bg-white">
                                                        <a href="filemanager-details.php"><img src="../assets/images/media/files/04.jpg" alt="img" height="124" class="w-100"></a>
                                                        <div class="card-footer">
                                                            <div class="d-flex">
                                                                <div class="">
                                                                    <h5 class="mb-0 fw-semibold text-break">image2.jpg</h5>
                                                ...
                                                <div class="item">
                                                    <div class="card overflow-hidden border p-0 mb-0 bg-white">
                                                        <a href="filemanager-details.php"><img src="../assets/images/media/files/05.jpg" alt="img" height="124" class="w-100"></a>
                                                        <div class="card-footer">
                                                            <div class="d-flex">
                                                                <div class="">
