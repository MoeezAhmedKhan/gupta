                            ...
                            <div class="row row-cards">
                                <div class="col-md-12 col-xl-6 col-xxl-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="card-transparent bg-primary-transparent border border-primary text-primary p-5 br-5">
                                ...
                                <div class="col-md-12 col-xl-6 col-xxl-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="card-transparent bg-success-transparent border border-success text-success p-5 br-5">
                                                <div class="d-flex d-xs-grid">
                                                    <span class="fs-30 pe-5"><i class="bi bi-alarm"></i></span>
                                                    <div class="">
                                ...
                                <div class="col-md-12 col-xl-6 col-xxl-4">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="card-transparent bg-warning-transparent border border-warning text-warning p-5 br-5">
                                                <div class="d-flex d-xs-grid">
                                                    <span class="fs-30 pe-5"><i class="bi bi-alarm"></i></span>
                                                    <div class="">
