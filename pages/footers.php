                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-md-12 social text-center">
                                                        <ul class="text-center d-inline-block">
                                                            ...
                                                            <li>
                                                                <a class="social-icon" href="https://twitter.com/" target="_blank"><i class="fa fa-twitter"></i></a>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <a class="social-icon" href="https://www.linkedin.com/" target="_blank"><i class="fa fa-linkedin"></i></a>
                                                            </li>
                                                            <li>
                                                                <a class="social-icon" href="https://myaccount.google.com/" target="_blank"><i class="fa fa-google-plus"></i></a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-12 col-sm-12 mt-3 mt-lg-0 text-center">
                                                        Copyright © 2022 <a href="javascript:void(0)">Sash</a>. Designed with by <a href="javascript:void(0)">Spruko</a> All rights reserved.
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-2 col-sm-6 col-md-4">
                                                        ...
                                                        <ul class="list-unstyled mb-4">
                                                            ...
                                                            <li><a href="file-manager.php">Other Pages</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-2 col-sm-6 col-md-4">
                                                        <h6>Information</h6>
                                            ...
                                            <footer class="main-footer px-0 pb-0">
                                                <div class="row">
                                                    <div class="col-xl-8 col-lg-12 col-md-12 footer1">Copyright © 2022 <a href="javascript:void(0)">Sash</a>. Designed with <span class="fa fa-heart text-danger"></span> by <a href="javascript:void(0)"> Spruko </a>
                                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="top-footer">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-sm-12 col-md-4">
                                                        <h6>Posts</h6>
                                                        <a href="blog.php"><img alt="" src="../assets/images/media/media1.jpg"></a>
                                                        <a href="blog.php"><img alt="" src="../assets/images/media/media2.jpg"></a>
                                                        <a href="blog.php"><img alt="" src="../assets/images/media/media3.jpg"></a>
                                                        <a href="blog.php"><img alt="" src="../assets/images/media/media4.jpg"></a>
                                                        <hr>
                                                        <h6 class="mb-0 m-t-30">Payments</h6>
                                                        <ul class="footer-payments">
                                                            <li><a href="javascript:void(0);"><i class="fa fa-cc-amex text-muted" aria-hidden="true"></i></a></li>
                                                            <li><a href="javascript:void(0);"><i class="fa fa-cc-visa text-muted" aria-hidden="true"></i></a></li>
                                                            <li><a href="javascript:void(0);"><i class="fa fa-credit-card-alt text-muted" aria-hidden="true"></i></a></li>
                                                            <li><a href="javascript:void(0);"><i class="fa fa-cc-mastercard text-muted" aria-hidden="true"></i></a></li>
                                                            <li><a href="javascript:void(0);"><i class="fa fa-cc-paypal text-muted" aria-hidden="true"></i></a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
