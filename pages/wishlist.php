                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-7 col-lg-6 col-md-7 col-sm-6">
                                                            <div class="float-sm-end float-none my-1">
                                                                <a href="cart.php" class="btn btn-primary me-2">Add All to Cart</a>
                                                        ...
                                                        <div class="product-grid6">
                                                            <div class="product-image6 p-5">
                                                                <ul class="icons-wishlist">
                                                                    <li><a href="javascript:void(0)" class="btn btn-danger" data-bs-dismiss="alert" aria-hidden="true"><i class="fe fe-heart"></i></a></li>
                                                                </ul>
                                                            ...
                                                            <div class="card-footer text-center">
                                                                <a href="cart.php" class="btn btn-primary mx-2 mb-1 w-sm"><i class="fe fe-shopping-cart me-2"></i>Add to cart</a>
