                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="tags">
                                                ...
                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-pill btn-warning text-white"><i class="mdi mdi-file-pdf me-2"></i> pdf_file.pdf</span></button>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="tags">
                                                ...
                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-pill btn-outline-warning"><i class="mdi mdi-file-pdf me-2"></i> pdf_file.pdf</span></button>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="tags">
                                                ...
                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-warning-light"><i class="mdi mdi-file-pdf me-2"></i> pdf_file.pdf</span></button>
                                    ...
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body">
                                            <div class="tags">
                                                ...
                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-warning-light btn-pill"><i class="mdi mdi-file-pdf me-2"></i> pdf_file.pdf</span></button>
                                ...
                                <div class="col-lg-6">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body p-4 p-sm-5">
                                            ...
                                            <div class="tags">
                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <a type="button" class="btn btn-primary text-white"><i class="mdi mdi-file-image mx-2"></i>Image01..._jpg</a>
                                                    <a type="button" class="btn btn-close btn-primary text-white" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </a>
                                                </div>

                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <a type="button" class="btn btn-outline-secondary"><i class="mdi mdi-file-image me-2"></i> Image_file.jpg </button>
                                                    <a type="button" class="btn btn-close btn-outline-secondary" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </a>
                                                </div>

                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <a type="button" class="btn btn-success-light"><i class="mdi mdi-file-image me-2"></i> Image_file.jpg </a>
                                                    <a type="button" class="btn btn-close btn-success-light" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="card custom-card">
                                        ...
                                        <div class="card-body p-4 p-sm-5">
                                            ...
                                            <div class="tags">
                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <a type="button" class="btn btn-pill btn-info text-white"><i class="mdi mdi-file-image mx-2"></i>Image01..._jpg</a>
                                                    <a type="button" class="btn btn-pill btn-close btn-info text-white" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </a>
                                                </div>

                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <a type="button" class="btn btn-pill btn-outline-warning"><i class="mdi mdi-file-image me-2"></i> Image_file.jpg </button>
                                                    <a type="button" class="btn btn-pill btn-close btn-outline-warning" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </a>
                                                </div>

                                                <div class="btn-group file-attach m-2" role="group" aria-label="Basic example">
                                                    <a type="button" class="btn btn-pill btn-danger-light"><i class="mdi mdi-file-image me-2"></i> Image_file.jpg </a>
                                                    <a type="button" class="btn btn-pill btn-close btn-danger-light" aria-label="Close">
                                                        <span aria-hidden="true">×</span>
                                                    </a>
                                                </div>
                                            </div>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4">
                                                            <div class="file-image p-2">
                                                                <a href="filemanager-details.php">
                                                                    <img src="../assets/images/pngs/4.jpg" alt="" class="w-100">
                                                                </a>
                                                                <ul class="icons">
                                                                    <li><a href="filemanager-details.php" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                                        ...
                                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4">
                                                            <div class="file-image p-2">
                                                                <a href="filemanager-details.php">
                                                                    <img src="../assets/images/pngs/file-image2.jpg" alt="" class="w-100">
                                                                </a>
                                                                <ul class="icons">
                                                                    <li><a href="filemanager-details.php" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                                        ...
                                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4">
                                                            <div class="file-image p-2">
                                                                <a href="filemanager-details.php">
                                                                    <img src="../assets/images/pngs/file-image3.jpg" alt="" class="w-100">
                                                                </a>
                                                                <ul class="icons">
                                                                    <li><a href="filemanager-details.php" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                                        ...
                                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4">
                                                            <div class="file-image p-2">
                                                                <a href="filemanager-details.php">
                                                                    <img src="../assets/images/pngs/file-image4.jpg" alt="" class="w-100">
                                                                </a>
                                                                <ul class="icons">
                                                                    <li><a href="filemanager-details.php" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                                        ...
                                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4">
                                                            <div class="file-image p-2">
                                                                <a href="filemanager-details.php">
                                                                    <img src="../assets/images/pngs/file-image5.jpg" alt="" class="w-100">
                                                                </a>
                                                                <ul class="icons">
                                                                    <li><a href="filemanager-details.php" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                                        ...
                                                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-4">
                                                            <div class="file-image p-2">
                                                                <a href="filemanager-details.php">
                                                                    <img src="../assets/images/pngs/file-image1.jpg" alt="" class="w-100">
                                                                </a>
                                                                <ul class="icons">
                                                                    <li><a href="filemanager-details.php" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                                                    <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
                                        ...
                                        <div class="card-body">
                                            <div class="text-wrap">
                                                <div class="file-image-1">
                                                    <a href="filemanager-details.php">
                                                        <img src="../assets/images/pngs/4.jpg" class="br-5" alt="">
                                                    </a>
                                                    <ul class="icons">
                                                        <li><a href="filemanager-details.php" class="btn bg-primary"><i class="fe fe-eye"></i></a></li>
                                                        <li><a href="javascript:void(0)" class="btn bg-secondary"><i class="fe fe-download"></i></a></li>
