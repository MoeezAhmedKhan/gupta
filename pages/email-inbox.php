                                        ...
                                        <div class="card">
                                            <div class="list-group list-group-transparent mb-0 mail-inbox pb-3">
                                                <div class="mt-4 mx-4 mb-4 text-center">
                                                    <a href="email-compose.php" class="btn btn-primary btn-lg d-grid">Compose</a>
                                                </div>
                                                <a href="email-read.php" class="list-group-item d-flex align-items-center active mx-4">
                                                    <span class="icons"><i class="ri-mail-line"></i></span> Inbox <span class="ms-auto badge bg-secondary bradius">14</span>
                                                </a>
                                                <a href="email-compose.php" class="list-group-item d-flex align-items-center mx-4">
                                                    <span class="icons"><i class="ri-mail-open-line"></i></span> Drafts
                                                </a>
                                                <a href="email-read.php" class="list-group-item d-flex align-items-center mx-4">
                                                    <span class="icons"><i class="ri-star-line"></i></span> Starred <span class="ms-auto badge bg-success bradius">03</span>
                                                </a>
                                                <a href="tags.php" class="list-group-item d-flex align-items-center mx-4">
                                            ...
                                            <div class="card-body border-top p-0 py-3">
                                                <div class="list-group list-group-transparent mb-0 mail-inbox mx-4">
                                                    <a href="blog-details.php" class="list-group-item list-group-item-action d-flex align-items-center py-2">
                                                        <span class="w-3 h-3 brround bg-primary me-2"></span> Friends
                                                    </a>
                                                    <a href="chat.php" class="list-group-item list-group-item-action d-flex align-items-center py-2">
                                                        <span class="w-3 h-3 brround bg-secondary me-2"></span> Family
                                                    </a>
                                                    <a href="profile.php" class="list-group-item list-group-item-action d-flex align-items-center py-2">
                                                        <span class="w-3 h-3 brround bg-success me-2"></span> Social
                                                    </a>
                                                    <a href="about.php" class="list-group-item list-group-item-action d-flex align-items-center py-2">
                                                        <span class="w-3 h-3 brround bg-info me-2"></span> Office
                                                    </a>
                                                    <a href="form-editor.php" class="list-group-item list-group-item-action d-flex align-items-center py-2">
                                                        <span class="w-3 h-3 brround bg-warning me-2"></span> Work
                                                    </a>
                                                    <a href="settings.php" class="list-group-item list-group-item-action d-flex align-items-center py-2">
                                                    ...
                                                    <table class="table table-inbox table-hover text-nowrap mb-0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Tim Reid, S P N</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Boost Your Website Traffic</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>April 01</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Freelancer.com</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Stop wasting your visitors</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>May 23</td>
                                                            </tr>
                                                            <tr class="unread">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="view-message  dont-show clickable-row" data-href='email-read.php'>PHPClass</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Added a new class: Login Class Fast Site</td>
                                                                <td class="view-message  text-end clickable-row" data-href='email-read.php'>9:27 AM</td>
                                                            </tr>
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Facebook</td>
                                                                <td class="view-message view-message clickable-row" data-href='email-read.php'>Somebody requested a new password </td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>June 13</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Skype</td>
                                                                <td class="view-message view-message clickable-row" data-href='email-read.php'>Password successfully changed</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>March 24</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Google+</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>alireza, do you know</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>March 09</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>WOW Slider </td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>New WOW Slider v7.8 - 67% off</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>March 14</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>LinkedIn Pulse</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>The One Sign Your Co-Worker Will Stab</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>Feb 19</td>
                                                            </tr>
                                                            <tr class="unread">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Google Webmaster </td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Improve the search presence of WebSite</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>March 15</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>JW Player</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Last Chance: Upgrade to Pro for </td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>March 15</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Drupal Community</td>
                                                                <td class="view-message view-message clickable-row" data-href='email-read.php'>Welcome to the Drupal Community</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>March 04</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="dont-show fw-semibold clickable-row" data-href='email-read.php'>Zoosk </td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>7 new singles we think you'll like</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>May 14</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark text-danger"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>LinkedIn </td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Alireza: Nokia Networks, System Group and </td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>February 25</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="dont-show fw-semibold clickable-row" data-href='email-read.php'>Facebook</td>
                                                                <td class="view-message view-message clickable-row" data-href='email-read.php'>Your account was recently logged into</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>March 14</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Twitter</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Your Twitter password has been changed</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>April 07</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>InternetSeer</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Performance Report</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>July 14</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark text-danger"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Bertina </td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>IMPORTANT: Don't lose your domains!</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>June 16</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark text-danger"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Laura Gaffin, S P N </td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Your Website On Google (Higher Rankings Are Better)</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>August 10</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Facebook</td>
                                                                <td class="view-message view-message clickable-row" data-href='email-read.php'>Alireza Zare Login faild</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>feb 14</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                    <label class="custom-control custom-checkbox mb-0 ms-3">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star inbox-started"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>AddMe.com</td>
                                                                <td class="view-message clickable-row" data-href='email-read.php'>Submit Your Website to the AddMe Business Directory</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>August 10</td>
                                                            </tr>
                                                            <tr class="">
                                                                <td class="inbox-small-cells">
                                                                ...
                                                                <td class="inbox-small-cells"><i class="fa fa-star"></i></td>
                                                                <td class="inbox-small-cells"><i class="fa fa-bookmark"></i></td>
                                                                <td class="view-message dont-show fw-semibold clickable-row" data-href='email-read.php'>Terri Rexer, S P N</td>
                                                                <td class="view-message view-message clickable-row" data-href='email-read.php'>Forget Google AdWords: Un-Limited Clicks fo</td>
                                                                <td class="view-message text-end fw-semibold clickable-row" data-href='email-read.php'>April 14</td>
                                                            </tr>
