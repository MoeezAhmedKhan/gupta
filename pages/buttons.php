                                            ...
                                            <div class="text-wrap">
                                                ...
                                                <div class="example">
                                                    <div class="btn-list">
                                                        ...
                                                        <a href="javascript:void(0)" class="btn btn-light btn-link">Link</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="text-wrap">
                                                ...
                                                <div class="example">
                                                    <div class="btn-list">
                                                        ...
                                                        <a href="javascript:void(0)" class="btn btn-light btn-link disabled">Link</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="example">
                                                    <div class="btn-list checkboxbtns">
                                                        <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group">
                                                            ...
                                                            <label class="btn btn-outline-primary border-start-end-0" for="btncheck2">Checkbox</label>
                                            ...
                                            <div class="text-wrap">
                                                ...
                                                <div class="example">
                                                    <div class="btn-group radiobtns" role="group" aria-label="Basic radio toggle button group">
                                                        ...
                                                        <label class="btn btn-outline-primary" for="btnradio111">Radio 1</label>

                                                        <input type="radio" class="btn-check" name="btnradio" id="btnradio112">
                                                        <label class="btn btn-outline-primary border-start-end-0" for="btnradio112">Radio 2</label>

                                                        <input type="radio" class="btn-check" name="btnradio" id="btnradio113">
                                                        <label class="btn btn-outline-primary" for="btnradio113">Radio 3</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
