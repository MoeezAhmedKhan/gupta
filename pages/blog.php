                ...
                <div class="main-content app-content mt-0">
                    <div class="side-app">
                        ...
                        <div class="main-container container-fluid">
                            ...
                            <div class="page-header">
                                ...
                                <div>
                                    <div class="breadcrumb">
                                        <a href="blog-post.php" class="btn btn-primary"><i class="fa fa-plus-square me-2"></i>Add Post</a>
                                    </div>
                                </div>
                            </div>
                            <!-- PAGE-HEADER END -->
                            ...
                            <!-- ROW-1 OPEN -->
                            <div class="row">
                                <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 col-xxl-4">
                                    <div class="card">
                                        <a href="blog-details.php"><img class="card-img-top" src="../assets/images/media/13.jpg" alt="And this isn&#39;t my nose. This is a false one."></a>
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <div class="d-flex align-items-center pt-5 mt-auto">
                                                ...
                                                <div>
                                                    <a href="profile.php" class="text-default">Megan Peters</a>
                                    ...
                                    <div class="card">
                                        <a href="blog-details.php"><img class="card-img-top" src="../assets/images/media/15.jpg" alt="How do you know she is a witch?"></a>
                                        <div class="card-body d-flex flex-column">
                                            <h3><a href="blog-details.php"> Voluptatem quia voluptas </a></h3>
                                ...
                                <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 col-xxl-4">
                                    <div class="card">
                                        <a href="blog-details.php"><img class="card-img-top" src="../assets/images/media/14.jpg" alt="Well, I didn&#39;t vote for you."></a>
                                        <div class="card-body d-flex flex-column">
                                            <h3><a href="blog-details.php"> Voluptatem quia voluptas </a></h3>
                                    ...
                                    <div class="card">
                                        <a href="blog-details.php"><img class="card-img-top" src="../assets/images/media/16.jpg" alt="Shut up!"></a>
                                        <div class="card-body d-flex flex-column">
                                            <h3><a href="blog-details.php"> Voluptatem quia voluptas </a></h3>
                                        ...
                                        <div class="card-body">
                                            <div class="">
                                                <div class="d-flex overflow-visible">
                                                    <a href="blog-details.php" class="card-aside-column br-5 cover-image" data-bs-image-src="../assets/images/media/22.jpg" style="background: url(&quot;../assets/images/media/18.jpg&quot;) center top;"></a>
                                                ...
                                                <div class="d-flex overflow-visible mt-5">
                                                    <a href="blog-details.php" class="card-aside-column br-5 cover-image" data-bs-image-src="../assets/images/media/about.jpg" style="background: url(&quot;../assets/images/media/19.jpg&quot;) center top;"></a>
                                                    <div class="ps-3 flex-column">
